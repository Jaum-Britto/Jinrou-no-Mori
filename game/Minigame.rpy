...
screen memory_mini_game:
    image "images\Minigames\Jogo_da_memoria\Minigames/Jogo da memoria/mini_game_BK.png"
    grid int(card_amount / card_rows) card_rows:
        ...
        for i, card in enumerate(cards):    
            if preview_mode:
                image "images\Minigames\Jogo_da_memoria\Minigames/Jogo da memoria/%s.png" % card[0]  # Exibe todas as cartas no modo preview
            elif card[1] == "deselected" and card[2] == "visible":
                imagebutton idle "images\Minigames\Jogo_da_memoria\Minigames/Jogo da memoria/card-back.png" sensitive (len(selected_cards) != 2) action Function(select_card, card_index=i) at card_fadein 
            elif card[1] == "selected" and card[2] == "visible":
                image "images\Minigames\Jogo_da_memoria\Minigames/Jogo da memoria/%s.png" % card[0] at card_fadein
            else:
                null
