...
translate Portugues strings:
    ...
    new "Avanço Automatico de Tempo"

    # game/screens.rpy:880
    old "Music Volume"
    new "Volume da musica"
    ...
    new "O dialogo da histora está vazio"
    ...
    new "Avançar dialogos e ativar interfaces"
